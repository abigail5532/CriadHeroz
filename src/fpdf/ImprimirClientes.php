...
class PDF extends FPDF
{
   ...
   function Header()
   {
      ...
      $this->Cell(70,10, 'Nombres y Apellidos',1,0,'C',0);
      $this->Cell(25,10, 'Telefono',1,0,'C',0);
      $this->Cell(70,10, 'Direccion',1,1,'C',0);
...
while($row = $resultado ->fetch_assoc()){
    $pdf->Cell(15,10, utf8_decode($row['idcliente']),1,0,'C',0);
    $pdf->Cell(70,10, $row['nombre'],1,0,'C',0);
    $pdf->Cell(25,10, $row['telefono'],1,0,'C',0);
    $pdf->Cell(70,10, utf8_decode($row['direccion']),1,1,'C',0);
}




$pdf->Output('ClientesReporte.pdf', 'I');//nombreDescarga, Visor(I->visualizar - D->descargar)